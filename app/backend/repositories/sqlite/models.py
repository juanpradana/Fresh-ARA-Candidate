...
class FeatureDaily(Base):
    ...
    vol_ratio_3d = Column(Float, nullable=False, default=0.0)
    vol_ratio_5d = Column(Float, nullable=False, default=0.0)
    vol_ratio_20 = Column(Float, nullable=False, default=0.0)
    cpr = Column(Float, nullable=False, default=0.0)
    range_volatility = Column(Float, nullable=False, default=0.0)
    bb_width = Column(Float, nullable=False, default=0.0)
    price_vs_ma20_pct = Column(Float, nullable=False, default=0.0)
    price_vs_ma50_pct = Column(Float, nullable=False, default=0.0)
    value_traded = Column(Float, nullable=False, default=0.0)
    rel_strength_5d_vs_jkse = Column(Float, nullable=False, default=0.0)
    float_shares = Column(Float, nullable=False, default=0.0)
    shares_outstanding = Column(Float, nullable=False, default=0.0)
    float_ratio = Column(Float, nullable=False, default=0.0)
    consecutive_green_days = Column(Integer, nullable=False, default=0)
    rsi14 = Column(Float, nullable=False, default=0.0)
    rsi14_slope = Column(Float, nullable=False, default=0.0)
    atr5_atr20_ratio = Column(Float, nullable=False, default=0.0)
    dist_to_52w_high_pct = Column(Float, nullable=False, default=0.0)
    is_ara_next_day = Column(Integer, nullable=False, default=0)
